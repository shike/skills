...
### Step 4.5：每周运势订阅钩子（获客 · 可选 · 推 public GitHub）

在 Step 4「行动建议」之后、Step 5「边界声明」之前，固定输出 `## 每周运势订阅` 区块（轻引导 + 持续获客）：
...
**注意**：
- "微信 usk021" 是公开 ID（已推 public GitHub repo）
- 弱引导："免费订阅"不是"立即购买"
- 不强推，保持塔罗的"娱乐调性"
